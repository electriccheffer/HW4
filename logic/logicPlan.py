...
def sentence1() -> Expr:
    ...
    sentence_one = variable_one | variable_two
    sentence_two = ~variable_one % (~variable_two | variable_three)
    sentence_three = Expr('|',~variable_one,~variable_two,variable_three) 
